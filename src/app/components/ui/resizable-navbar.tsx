...
export const MobileNavToggle = ({
  ...
  return (
    <button
      onClick={onClick}
      className="p-2 rounded-lg hover:bg-gray-100 dark:hover:bg-neutral-800 transition-colors focus:outline-none focus:ring-2 focus:ring-blue-500"
...
export const NavbarLogo = ({ mobile = false }: { mobile?: boolean }) => {
  return (
    <a
      href="#"
      className={cn(
        "relative z-20 flex items-center space-x-2 px-2 py-1 text-sm font-normal text-black",
        mobile ? "mr-2" : "mr-4"
      )}
    >
      <Image
...
export const NavbarPNUDLogo = ({ mobile = false }: { mobile?: boolean }) => {
  return (
    <a
